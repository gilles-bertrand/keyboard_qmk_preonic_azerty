...
[_LOWER] = LAYOUT_preonic_grid(
  KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_5, KC_MINS, KC_BSPC,
  KC_TAB, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, FR_LBRC, FR_RBRC, KC_DEL,
  KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_UNDS, KC_PLUS, FR_LCBR, FR_RCBR, FR_PIPE,
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, _______,_______,KC_TILD, KC_GRV, _______,
...
[_RAISE] = LAYOUT_preonic_grid(
  _______,  _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    FR_SLSH,    FR_BSLS,    KC_BSPC,
